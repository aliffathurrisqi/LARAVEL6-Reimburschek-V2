                                ...
                                <div class="col-sm-12 p-2">
                                        ...
                                        <table class="table table-bordered  table-vcenter js-dataTable-full">
                                            ...
                                            <tbody>
                                                ...
                                                @foreach ($reimbesements->outlet_details() as $item)
                                                <?php $no = true ?>
                                                ...
                                                <tr>
                                                    @if ($i == 0)
                                                    <td class="text-center" rowspan="{{ $reimbesements->detail_total() }}">{{ $reimbesements->reimbesement_date->isoFormat("D MMMM Y") }}</td>
                                                    @endif
